...
$InfosTentatives=$db->prepare("SELECT * FROM tentative WHERE nom_joueur=:nj");
                    ...
                    <tbody>
                        ...
                        while($InfosTentativesJoueur=$InfosTentatives->fetch()){?>
                            <tr>  
                                ...
                                <td><?php echo $InfosTentativesJoueur["niveau"]?></td>
                                <td><?php echo $InfosTentativesJoueur["numero"]?></td>
                                <td><?php echo $InfosTentativesJoueur["gain"]?></td>
                                <td><?php echo $InfosTentativesJoueur["dateJeux"]?></td>      
                            </tr>      
                        <?php } ?>
                    </tbody>
                </table>
