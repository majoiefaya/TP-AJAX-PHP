   ...
   <body>
    <header>
        <nav class="menu">
            ...
            <section id="sect2">
                <a href="Serveur/DeconnexionController.php" type="submit" class="btn btn-warning">Deconnexion</a>
                <p id="salutation">Bienvenue Msr  <span id="nom"><?php echo $_SESSION["nom"]?></span>
                <span><?php echo " "; echo $_SESSION["prenom"]?></span></p>
            </section>
        </nav>
    </header>
        ...
        <div class="div">
            ...
            <form method="post" class="SelectRes">
                ...
                <div class="portfeuille">
                    <span id="portfeuille"><?php echo $solde ?></span><span title="Somme Total du joueur"> franc</span>
                </div>
            ...
            <h1 id="id_joueur" hidden ><?php echo $joueur_id ?></h1>
